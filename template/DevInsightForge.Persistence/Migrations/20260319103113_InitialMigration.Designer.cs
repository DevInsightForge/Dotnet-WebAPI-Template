...
namespace DevInsightForge.Persistence.Migrations
{
    ...
    [Migration("20260319103113_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevInsightForge.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DevInsightForge.Domain.Entities.Role", b =>
                {
                    b.HasOne("DevInsightForge.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("DevInsightForge.Domain.Entities.User", "ModifiedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DevInsightForge.Domain.Entities.User", b =>
                {
                    b.HasOne("DevInsightForge.Domain.Entities.Role", "Role")
                        .WithMany()
