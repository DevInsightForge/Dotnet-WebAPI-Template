...
public class EncryptionService(IOptions<JwtConfigurations> jwtOptions) : IEncryptionService
{
    private static readonly TimeSpan OtpLifetime = TimeSpan.FromMinutes(10);
    private static readonly TimeSpan OtpTimeStep = TimeSpan.FromMinutes(5);
    private readonly string _otpSecretKey = jwtOptions.Value.SecretKey;
